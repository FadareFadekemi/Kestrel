    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 13, color: c.mut, margin: 0 }}>work smart, rise sharp</p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, color: c.txt, margin: '0 0 6px' }}>
            {mode === 'login' ? 'Welcome back' : 'Create your account'}
          </h2>
          <p style={{ fontSize: 13, color: c.mut, margin: '0 0 24px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: c.mut, padding: 4, display: 'flex' }}
              >
            ...
            <button
              ...
              style={{
                background: loading ? c.brd : 'linear-gradient(135deg, #00D4C8, #00B8AD)',
                color: loading ? c.mut : c.bg,
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: c.mut, marginTop: 20, marginBottom: 0 }}>
...
function Field({ icon, paddingRight, colors: c, ...props }) {
  return (
    <div style={{ position: 'relative' }}>
      ...
      <input
        {...props}
        style={{
          width: '100%', background: c.bg, border: '1px solid #264040',
